...
class User::PasswordResetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should successfully do reset' do
    post user_password_resets_url, params: {
      user_password_reset: { password_reset_token: 'Tm8Gv9VP4XsHnIJyosk7', password: 'new_password', password_confirmation: 'new_password' }
    }
  ...
  test 'should fail to do a password reset with a wrong token' do
    post user_password_resets_url, params: {
      user_password_reset: { password_reset_token: 'wrong_token', password: 'new_password', password_confirmation: 'new_password' }
    }
  ...
  test 'should fail to do a password reset with non-matching password' do
    post user_password_resets_url, params: {
      user_password_reset: { password_reset_token: 'Tm8Gv9VP4XsHnIJyosk7', password: 'new_password', password_confirmation: 'new_password2' }
    }
